              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    alert('Función de Google Auth próximamente disponible')
                  }}
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-gray-50 border border-gray-300 rounded-lg text-gray-700 font-medium transition-colors"
                >
